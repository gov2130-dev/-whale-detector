...
st.markdown("""
<style>
.stButton>button {width:100%; text-align:right; font-size:16px; margin:3px 0; border-radius:10px}
</style>
...
def get_all_tickers():
    try:
        ...
        return ["SPY","QQQ","TSLA","NVDA","AAPL","AMZN","META","MSFT","GOOGL","AMD","NFLX","SMCI","COIN","MSTR","PLTR","GME","AMC"]

HOT_OPTIONS = ["SPY","QQQ","IWM","TSLA","NVDA","AAPL","AMZN","META","MSFT","GOOGL","AMD","NFLX","SMCI","COIN","MSTR","PLTR","GME","MARA","SOFI","NIO","AAL","GLD","SLV","TLT","VIX"]
