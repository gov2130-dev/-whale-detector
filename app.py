...
st.set_page_config(layout="wide", page_title="Whale V29 Final - No Flicker", initial_sidebar_state="expanded")
...
st.title("🐋 Whale V29 - الأصلي الأقوى 🔥 بدون بهوت - 0DTE = دبلات")
