...
st.set_page_config(layout="wide", page_title="Whale V35.1 Fixed - 12 شرط", initial_sidebar_state="expanded")
...
.whale-table td {background:#fff!important; padding:18px 12px; text-align:center; font-weight:700; color:#1c1917!important; border:1.5px solid #f5f5f4;}
...
.score-12 {background:linear-gradient(135deg,#14532d,#16a34a)!important; color:#dcfce7!important; padding:10px 18px; border-radius:22px; font-weight:900; border:2px solid #4ade80;}
...
def get_all_tickers():
    return ["SPY","QQQ","SPX","NDX","TSLA","NVDA","AAPL","AMZN","META","MSFT","GOOGL","AVGO","NFLX","AMD","COIN","MSTR","PLTR","SOFI","GME","MARA","JPM","XOM","UNH","COST","LLY","CRM","ADBE","PANW","CRWD","UBER","HOOD","SMCI","ARM","MU","QCOM"]
